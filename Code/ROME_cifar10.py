...
from utils import total_variation, clip_function, negative_log_likelihood, visualize_tsne, total_variation_2, neg_log_two_times_one_minus_tv
...
def main():
    ...
    parser.add_argument('--ce_weight', type=float, default=1, help='outer loop for network update')
